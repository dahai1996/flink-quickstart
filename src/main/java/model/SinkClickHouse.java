...
public class SinkClickHouse<T> {
     ...
     */
    public SinkClickHouse(String sql, JdbcStatementBuilder<T> jdbcStatementBuilder,
    ...
    public static void setPs(PreparedStatement ps, Field[] fields, Object bean) throws IllegalAccessException, SQLException {
        for (int i = 1; i <= fields.length; i++) {
            ...
            String fieldValue = field.get(bean).toString();
            if (fieldValue != null && !NA.equals(fieldValue) && !"".equals(fieldValue)) {
