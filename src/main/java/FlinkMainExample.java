 ...
 * @author wfs
 */
public class FlinkMainExample extends FlinkMainModel {
    public static void main(String[] args) throws Exception {
        ...
        // 2.从jar包中读取配置文件
        ParameterTool pro2 = getProFromJar(FlinkMainExample.class, "/flink-quickstart.properties");
        ...
        // 此处可以请求必填配置参数
        String required = pro.getRequired("");
